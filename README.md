# Marca Personal — Alberto Ruiz de Infante

## Objetivo
Construir marca personal de forma progresiva para tener opciones abiertas en el futuro:
posibles cambios laborales y/o monetización propia. Sin prisa, con consistencia.

## Filosofía
- Mostrar, no proclamar — demostrar conocimiento sin pedantería
- Lenguaje natural y cercano
- Publicar poco pero con valor real
- Progresión gradual: empezar despacio y ser consistente

## Narrativa central
Profesional con 25 años de experiencia en finanzas, gestión de riesgos y desarrollo de negocio,
con visión global (Asia-Pacífico, Australia, Sudáfrica, Europa) y perfil tecnológico real
(Python, IA, datos). Alguien que entiende el negocio Y sabe construir herramientas para mejorarlo.

## Plataformas (por orden de prioridad)
1. **LinkedIn** — base principal, optimizar primero
2. **GitHub** — proyectos propios (portfolio-monitor, etc.)
3. **Substack o X** — a valorar en fase 2

## Progresión planificada
- **Fase 1** (1-2 meses): optimizar LinkedIn sin publicar — titular, about, skills, experiencia
- **Fase 2** (2-4 meses): 1-2 publicaciones/mes cuando haya algo genuino que decir
- **Fase 3**: valorar Substack/X si hay ritmo
